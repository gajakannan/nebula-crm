...
public static class OpportunityStatusCatalog
{
    ...
    [
        ...
        new("Bound", "Bound", "Policy bound and issued", true, 12, "won"),
        new("Declined", "Declined", "Submission declined by underwriter", true, 13, "lost"),
        new("Withdrawn", "Withdrawn", "Broker or insured withdrew submission", true, 14, "lost"),
        new("NotQuoted", "Not Quoted", "Submission closed without quote issued", true, 15, "lost"),
        new("Lost", "Lost", "Opportunity lost to another market or strategy change", true, 16, "lost"),
        new("Expired", "Expired", "Submission expired before disposition completed", true, 17, "lost"),
    ];
