...
public class PolicyAuthorizationService : IAuthorizationService
{
    ...
    [
        ...
        new("DistributionUser", "dashboard_opportunities", "read"),
        new("DistributionManager", "dashboard_opportunities", "read"),
        new("Underwriter", "dashboard_opportunities", "read"),
        new("RelationshipManager", "dashboard_opportunities", "read"),
        new("ProgramManager", "dashboard_opportunities", "read"),
        new("Admin", "dashboard_opportunities", "read"),
