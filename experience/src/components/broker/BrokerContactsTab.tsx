  ...
  return (
    <div>
      ...
      {contacts && contacts.length === 0 && (
        <p className="py-8 text-center text-sm text-zinc-500">No contacts yet.</p>
      )}
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-zinc-800 p-3">
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-0.5 flex flex-wrap gap-3 text-xs text-zinc-400">
      ...
      <div className="ml-2 flex gap-1">
        ...
        <button
          onClick={onDelete}
          className="rounded-md p-1.5 text-zinc-500 transition-colors hover:bg-status-error/15 hover:text-status-error"
