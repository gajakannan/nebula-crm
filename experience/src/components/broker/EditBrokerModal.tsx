    ...
    <Modal open={open} onClose={onClose} title="Edit Broker">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1.5">
          <label className="block text-xs font-medium text-zinc-400">License Number</label>
          <p className="rounded-lg border border-zinc-800 bg-zinc-950/50 px-3 py-2 font-mono text-sm text-zinc-500">
